...
public class TestItemStackOperators {
    ...
    public void before() {
        ...
        IEnergyStorage energyStorage = energyBatteryFull.getCapability(ForgeCapabilities.ENERGY).orElse(null);
        ...
        IItemHandler itemHandler = shulkerBox.getCapability(ForgeCapabilities.ITEM_HANDLER).orElse(null);
