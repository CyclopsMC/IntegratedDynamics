...
public class TestVariables {
    ...
    public void testRecipeType() {
        ...
        TestHelpers.assertEqual(r0.getType().serialize(r0.getValue()), "{output:{\"minecraft:energy\":[777],\"minecraft:fluidstack\":[{FluidName:\"water\",Amount:123}],\"minecraft:itemstack\":[{id:\"minecraft:boat\",Count:1b,Damage:0s},{id:\"minecraft:stone\",Count:1b,Damage:0s}]},input:{\"minecraft:itemstack\":[[{condition:7,prototype:{id:\"minecraft:air\",Count:1b,Damage:0s}}],[{condition:7,prototype:{id:\"minecraft:boat\",Count:1b,Damage:0s}}],[{condition:7,prototype:{id:\"minecraft:stone\",Count:1b,Damage:0s}}],[{condition:7,prototype:{id:\"minecraft:air\",Count:1b,Damage:0s}}]]}}", "Serialization is correct");
