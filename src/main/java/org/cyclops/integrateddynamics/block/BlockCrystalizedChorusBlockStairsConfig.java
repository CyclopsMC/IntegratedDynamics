...
public class BlockCrystalizedChorusBlockStairsConfig extends BlockConfig {
    ...
    protected ConfigurableBlockStairs initSubInstance() {
        ConfigurableBlockStairs block = (ConfigurableBlockStairs) new ConfigurableBlockStairs(this, BlockCrystalizedChorusBlockConfig._instance.getBlockInstance().getDefaultState()) {
