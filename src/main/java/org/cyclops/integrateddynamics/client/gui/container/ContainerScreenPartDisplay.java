...
public class ContainerScreenPartDisplay<P extends PartTypePanelVariableDriven<P, S>, S extends PartTypePanelVariableDriven.State<P, S>>
    ...
    public void init() {
        ...
        addButton(new ButtonText(getGuiLeftTotal() + 128, getGuiTopTotal() + 32, 30, 12,
                L10NHelpers.localize("gui.integrateddynamics.button.copy"),
                L10NHelpers.localize("gui.integrateddynamics.button.copy"),
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        displayErrors.drawBackground(getContainer().getReadErrors(), ERROR_X, ERROR_Y, OK_X, OK_Y, this,
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        displayErrors.drawForeground(getContainer().getReadErrors(), ERROR_X, ERROR_Y, mouseX, mouseY, this, this.guiLeft, this.guiTop);
