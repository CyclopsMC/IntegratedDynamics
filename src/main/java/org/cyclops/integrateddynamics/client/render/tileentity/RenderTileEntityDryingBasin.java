 ...
 *
 */
public class RenderTileEntityDryingBasin extends TileEntitySpecialRenderer implements RenderHelpers.IFluidContextRender {
	...
	public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float partialTickTime, int partialDamage) {
        ...
        if(tile != null) {
            ...
            lastTile = tile;
            RenderHelpers.renderTileFluidContext(tile.getTank().getFluid(), x, y, z, tileEntity, this);
        }
	}
