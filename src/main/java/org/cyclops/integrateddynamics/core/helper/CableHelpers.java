...
public class CableHelpers {
    ...
    public static boolean onCableRemoving(Level world, BlockPos pos, boolean dropMainElement, boolean saveState, BlockState blockState) {
        return onCableRemoving(world, pos, dropMainElement, saveState, blockState, false);
    }
     ...
     * @return If the cable was removed from the network.
     */
    public static boolean onCableRemoving(Level world, BlockPos pos, boolean dropMainElement, boolean saveState, BlockState blockState, boolean isMoving) {
