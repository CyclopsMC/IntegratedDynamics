...
public class OperatorBuilders {
    ...
    public static final OperatorBuilder<OperatorBase.SafeVariablesGetter> FLUIDSTACK_3 = FLUIDSTACK.inputTypes(3, ValueTypes.OBJECT_FLUIDSTACK).renderPattern(IConfigRenderPattern.PREFIX_3_LONG);
