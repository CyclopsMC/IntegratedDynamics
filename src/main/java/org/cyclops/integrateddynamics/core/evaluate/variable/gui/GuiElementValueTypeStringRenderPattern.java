 ...
 */
@OnlyIn(Dist.CLIENT)
public class GuiElementValueTypeStringRenderPattern<S extends ISubGuiBox, G extends AbstractGui, C extends Container> extends RenderPattern<GuiElementValueTypeString<G, C>, G, C> implements IDropdownEntryListener<IOperator> {

    @Getter
    protected final GuiElementValueTypeString<G, C> element;
    @Getter
    private WidgetTextFieldDropdown<IOperator> searchField = null;
    ...
    protected Set<IDropdownEntry<IOperator>> getDropdownPossibilities() {
