...
public class RecipeSerializerMechanicalDryingBasin implements RecipeSerializer<RecipeMechanicalDryingBasin> {
    ...
    public static final Codec<RecipeMechanicalDryingBasin> CODEC = RecordCodecBuilder.create(
    ...
    @Override
    public Codec<RecipeMechanicalDryingBasin> codec() {
        return CODEC;
    }

    @Override
    public RecipeMechanicalDryingBasin fromNetwork(FriendlyByteBuf buffer) {
        // Input
        ...
        return new RecipeMechanicalDryingBasin(inputIngredient, inputFluid, outputItem, outputFluid, duration);
    }
