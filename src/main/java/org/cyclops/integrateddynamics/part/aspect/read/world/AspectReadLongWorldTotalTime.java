 ...
 * @author rubensworks
 */
public class AspectReadLongWorldTotalTime extends AspectReadLongWorldBase {
    ...
    protected ValueTypeLong.ValueLong getValue(PartTarget target, IAspectProperties properties) {
        return ValueTypeLong.ValueLong.of(target.getTarget().getPos().getWorld().getTotalWorldTime());
    }
}
