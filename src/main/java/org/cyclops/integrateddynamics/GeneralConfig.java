...
public class GeneralConfig extends DummyConfig {
    ...
    @ConfigurableProperty(category = "general", comment = "The base energy usage for the delay.", minimalValue = 0, configLocation = ModConfig.Type.SERVER)
    public static int delayBaseConsumption = 2;
