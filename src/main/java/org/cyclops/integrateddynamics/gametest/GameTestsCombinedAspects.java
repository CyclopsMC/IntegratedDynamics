...
public class GameTestsCombinedAspects {
    ...
    public void testCombinedAspectsWriterPersistsAfterNetworkRebuild(GameTestHelper helper) {
        ...
        placeVariableInWriter(helper, helper.getLevel(), writerPos, Aspects.Write.Redstone.BOOLEAN, createVariableForValue(helper.getLevel(), ValueTypes.BOOLEAN, ValueTypeBoolean.ValueBoolean.of(true)));
    ...
    public void testCombinedAspectsWriterActivatesWithoutPlayer(GameTestHelper helper) {
        ...
        placeVariableInWriter(helper, helper.getLevel(), writerPos, Aspects.Write.Redstone.BOOLEAN,
