...
public class TestPartConfigSnapshot {
    ...
    private static final Identifier PART_TYPE = Identifier.parse("integrateddynamics:redstone_writer");
    private static final Identifier ASPECT = Identifier.parse("integrateddynamics:write_boolean_redstone");
